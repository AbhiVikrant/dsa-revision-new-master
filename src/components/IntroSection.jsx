  ...
  return (
    <>
      <div className="mainDiv flex flex-col justify-between sm:mx-8 ">
        <div>
          <div className="introStart gap-2 flex flex-col lg:flex lg:flex-col  ">
